...
**Weiter offen (nachgemessen 22:42):** `alle-pruefer.mjs` 112 gelaufen, **3 rot** — `pruefe-taschkil.js` und `pruefe-themen.mjs` (beide warten auf Elias, unverändert) und `pruefe-gedaechtnis-zahlen.mjs`, weil im Gedächtnis noch v526 als höchste Fassung stand; mit dem Vault-Eintrag von 22:45 erledigt. Bedingt: weiterhin `data/boxen.json`/`angefangen` nach dem nächsten Lauf.
