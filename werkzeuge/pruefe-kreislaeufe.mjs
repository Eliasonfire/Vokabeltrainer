...
const SPEICHER_AUSNAHMEN = {
  ...
  'vt_suraGelesenZeit': 'wann der Haken je Sure zuletzt ANGEFASST wurde (17.09.2026) — reine Entscheidungshilfe fuer den Geraeteabgleich, wie vt_settingsFeld fuer die Einstellungen. Ausgewertet wird er im Zweig fuer vt_suraGelesen in js/sync.js: seit Elias den Haken zuruecknehmen kann („damit es nicht mehr als gelesen gilt"), gewinnt je Sure der SPAETERE Handgriff und nicht mehr das juengere Datum — sonst holte der Abgleich jede Ruecknahme wieder zurueck. Geprueft von test-sync.mjs',
