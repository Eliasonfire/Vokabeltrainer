...
const GRAMMAR_RULES = [
  ...
  {
    id: "schams-qamar-01",
    /* Elias am 19.08.2026: "diese sachen koennen auch noch im satzmodus gerne
       bleiben auch das mit sonne und mond aber nicht bei den karteikarten als
...
const SENTENCE_TAGS = {
  ...
  "45913": [
    { ruleId: "schams-qamar-01", matchText: "الضَّيْفُ" },
    { ruleId: "harf-jarr-fi-ala-01", matchText: "فِي الْبَيْتِ" }
  ],
  "45914": [
    { ruleId: "mubtada-khabar-01", matchText: "الْفَلَّاحُ" },
    { ruleId: "harf-jarr-01", matchText: "فِي الْحَقْلِ" }
  ],
  "45915": [
    { ruleId: "al-gesamtheit-01", matchText: "النَّاسُ" },
    { ruleId: "schams-qamar-01", matchText: "السُّوقِ" }
  ],
  "45916": [
    { ruleId: "mubtada-khabar-01", matchText: "الْمَطْعَمُ قَرِيبٌ" },
    { ruleId: "mina-al-01", matchText: "مِنَ الْجَامِعَةِ" }
  ],
  "45917": [
    { ruleId: "schams-qamar-01", matchText: "الشَّيْخُ" },
    { ruleId: "harf-jarr-fi-ala-01", matchText: "فِي الْمَسْجِدِ" }
  ],
  "45918": [
    { ruleId: "mubtada-khabar-01", matchText: "الْأُسْتَاذَةُ" },
    { ruleId: "harf-jarr-fi-ala-01", matchText: "فِي الْجَامِعَةِ" }
  ],
  "45919": [
    { ruleId: "ismul-isara-hadhihi-01", matchText: "هَذِهِ" },
    { ruleId: "nat-wen-beschreibt-01", matchText: "مُجْتَهِدَةٌ" }
  ],
  "45920": [
    { ruleId: "idafa-01", matchText: "زَوْجُ الْمُدَرِّسَةِ" },
    { ruleId: "nakira-marifa-01", matchText: "تَاجِرٌ" }
  ],
  "45921": [
    { ruleId: "mudaf-01", matchText: "دُسْتُورُ" },
    { ruleId: "mudaf-ilayh-01", matchText: "الْمَمْلَكَةِ" }
  ],
  "45922": [
    { ruleId: "al-gesamtheit-01", matchText: "الْقِبْلَةُ" },
    { ruleId: "harf-jarr-min-ila-01", matchText: "إِلَى الْكَعْبَةِ" }
  ],
  "45923": [
    { ruleId: "mubtada-khabar-genus-01", matchText: "الْمَحْكَمَةُ قَرِيبَةٌ" },
    { ruleId: "iltiqa-sakinain-01", matchText: "مِنَ السُّوقِ" }
  ],
  "45924": [
    { ruleId: "mudaf-ohne-al-01", matchText: "حَفِيدُ" },
    { ruleId: "mudaf-ilayh-01", matchText: "الشَّيْخِ" }
  ],
  "45925": [
    { ruleId: "mubtada-khabar-genus-01", matchText: "الْحَدِيقَةُ جَمِيلَةٌ" },
    { ruleId: "mutabaqa-genus-01", matchText: "وَنَظِيفَةٌ" }
  ],
  "45926": [
    { ruleId: "mubtada-khabar-01", matchText: "رَجَبٌ" },
    { ruleId: "marfu-grundfall-01", matchText: "قَرِيبٌ" }
  ],
  "45927": [
    { ruleId: "marfu-grundfall-01", matchText: "الْأُسْتَاذَةُ" },
    { ruleId: "mina-al-01", matchText: "مِنَ الْيُونَانِ" }
  ],
  "45928": [
    { ruleId: "mubtada-khabar-01", matchText: "الْمَطَارُ بَعِيدٌ" },
    { ruleId: "iltiqa-sakinain-01", matchText: "مِنَ الْمَدِينَةِ" }
  ],
  "45929": [
    { ruleId: "idafa-erkennen-01", matchText: "كُلِّيَّةُ الطِّبِّ" },
    { ruleId: "harf-jarr-fi-ala-01", matchText: "فِي الْجَامِعَةِ" }
  ],
  "45930": [
    { ruleId: "mudaf-ohne-al-01", matchText: "كُلِّيَّةُ" },
    { ruleId: "mubtada-khabar-genus-01", matchText: "جَدِيدَةٌ" }
  ],
  "45931": [
    { ruleId: "mudaf-ilayh-01", matchText: "التِّجَارَةِ" },
    { ruleId: "mina-al-01", matchText: "مِنَ الْمَكْتَبَةِ" }
  ],
  "45932": [
    { ruleId: "schams-qamar-01", matchText: "الشَّرِيعَةِ" },
    { ruleId: "mutabaqa-genus-01", matchText: "مَشْهُورَةٌ" }
  ],
  "45933": [
    { ruleId: "mudaf-01", matchText: "نَبِيُّ" },
    { ruleId: "lafz-al-jalala-01", matchText: "اللهِ" }
  ],
  "45934": [
  ...
  "397cfa89-5bc0-4ce7-ae45-30fe8ea64fe2": [
    { ruleId: "harf-jarr-01", matchText: "فِي الْبَيْتِ" }
  ],
  ...
  "gram-pron-huwa": [
    { ruleId: "verb-madi-endungen-01", matchText: "ذَهَبَ" }
  ],
  "gram-pron-huma-m": [
    { ruleId: "verb-madi-endungen-01", matchText: "ذَهَبَا" }
  ],
  "gram-pron-hum": [
    { ruleId: "verb-madi-endungen-01", matchText: "ذَهَبُوا" }
  ],
  "gram-pron-hiya": [
    { ruleId: "verb-madi-endungen-01", matchText: "ذَهَبَتْ" }
  ],
  "gram-pron-hunna": [
    { ruleId: "verb-madi-endungen-01", matchText: "ذَهَبْنَ" }
  ],
  "gram-pron-anta": [
    { ruleId: "verb-madi-endungen-01", matchText: "ذَهَبْتَ" }
  ],
  "gram-pron-antuma": [
    { ruleId: "verb-madi-endungen-01", matchText: "ذَهَبْتُمَا" }
  ],
  "gram-pron-antum": [
    { ruleId: "verb-madi-endungen-01", matchText: "ذَهَبْتُمْ" }
  ],
  "gram-pron-anti": [
    { ruleId: "verb-madi-endungen-01", matchText: "ذَهَبْتِ" }
  ],
  "gram-pron-antunna": [
    { ruleId: "verb-madi-endungen-01", matchText: "ذَهَبْتُنَّ" }
  ],
  "gram-pron-ana": [
    { ruleId: "verb-madi-endungen-01", matchText: "ذَهَبْتُ" }
  ],
  "gram-pron-nahnu": [
...
const SATZ_THEMEN = [
  ...
  /* ⭐ Neu am 24.08.2026 fuer Folge 18. Vorher passte die Verbkonjugation in
     KEINES der dreizehn Themen — die Regel waere nur unter „Alle" erschienen
     und im Satzmodus unauffindbar gewesen. Das Muster ist bewusst offen fuer
     `mudari-`: die Gegenwart kommt laut Video als Naechstes.

     ⭐ Es traegt bewusst AUCH verb-enthaelt-pronomen-01 (Folge 05, 27:41,
     „das er steckt im Verb") — dieselben Verben خَرَجَ / ذَهَبَ, und inhaltlich
     die Vorstufe: dort lernt er, dass bei هُوَ KEINE Endung steht, hier, dass
